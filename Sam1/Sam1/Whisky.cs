...
namespace Sam1
{
    class Whisky
    {
        ...
        public List<Whisky> listOfWhisky { get; set; } = new List<Whisky>();
        ...
        public Whisky(string name,int Cena,int vidergka,string country,string creater)
        {
            this.Name = name;
            this.Cenas = Cena;
        ...
        public void Add()
        {
            ...
            listOfWhisky.Add(new Whisky() { Name=Name,Cenas=Cenas, Vidergka=Vidergka, Country=Country,Creater=Creater});
        }
